...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
void URamaMeleeWeapon::RamaReportsChaosPhysicsShapesWentInvalidOnUs()
{
	float Now = FApp::GetCurrentTime();
	
	if(Now - RamaChaosEngineLastRepairTime < RamaChaosEngineRepairMaxFrequencySeconds)
	{
		return;
	}
	//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	...
	//Set!
	RamaChaosEngineLastRepairTime = Now;
	
	//Broadcast
	if(RamaMeleeWeapon_ChaosEngineFix.IsBound())
	{
		RamaMeleeWeapon_ChaosEngineFix.Broadcast(this);
	}
	 
	//Fix!
	RamaChaosEngineRepair();
}

void URamaMeleeWeapon::RamaChaosEngineRepair()
{   
...
void URamaMeleeWeapon::Draw()
{
	...
	URamaMeleeCore::DrawRamaMeleeComp(this,DrawShapes_Thickness);
}
...
void URamaMeleeWeapon::StartSwingDamage()
{
	...
	//Capture the same engine frame tick as the Anim Notify Start itself <3 Rama
	SwingTick();
