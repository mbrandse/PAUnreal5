...
public:
	...
	*/
	...
	UPROPERTY(Category="Rama Save System", EditAnywhere, BlueprintReadOnly)
	FString ActorStreamingLevel = "";
	
	/** 
		This lookup is SLOW, Use ActorStreamingLevel variable instead.
		
		This function tells you which streaming level the owner of this component is part of!!!! Yes!!! Those of you using UE4's Level Streaming system will love me for this! 
		
		Because it is a slow lookup, I cache the value in ActorStreamingLevel variable when component BeginPlay occurs. 
	...
	*/
	...
	/** If this is false, the actor will not be deleted during a load process even if DestroyActorsBeforeLoad was set to true */
	UPROPERTY(Category="Rama Save System", EditAnywhere, BlueprintReadWrite)
	bool DestroyBeforeLoad = true;
...
public:
	...
	/** This is called just before destroying an actor during the load process. It will be recreated if present in the save file. */
	UPROPERTY(Category="Rama Save System", BlueprintAssignable)
	FRamaSavePreLoadDestroySignature RamaSaveEvent_PreLoadDestroy;
...
public:
	...
	FString LoadedLevelPackageName = "Uninitialized Data";
