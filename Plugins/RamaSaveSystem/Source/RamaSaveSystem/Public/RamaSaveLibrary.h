...
public:
	...
	*/
	...
	/** 
		...
		@param IgnoreStreamingActorsIfNoLevelSpecified If this is true, then actors in streaming levels will be ignored if saving with no streaming level specified! <3 Rama
	...
	*/
	...
	static void RamaSave_SaveToFile(
		...
		bool IgnoreStreamingActorsIfNoLevelSpecified=false,
		URamaSaveObject* StaticSaveData = nullptr
	){
		TArray<FString> SaveOnlyActorsWithTags;
		RamaSave_SaveToFile_WithTags(WorldContextObject, FileName, FileIOSuccess, AllComponentsSaved, SaveOnlyActorsWithTags, SaveOnlyStreamingLevel, IgnoreStreamingActorsIfNoLevelSpecified, StaticSaveData);
	}
	...
	*/
	UFUNCTION(Category="Rama Save System", BlueprintCallable,meta=(WorldContext="WorldContextObject"))
	static void RamaSave_SaveToFile_WithTags(
		UObject* WorldContextObject, 
		FString FileName, 
		bool& FileIOSuccess, 
		bool& AllComponentsSaved, 
	...
	*/
	UFUNCTION(Category="Rama Save System", BlueprintCallable,meta=(WorldContext="WorldContextObject"))
	static void GetAllRamaSaveComponents(UObject* WorldContextObject, TArray<URamaSaveComponent*>& RamaSaveComponents, FString GetOnlyStreamingLevelName="",bool IgnoreStreamingActorsIfNoStreamingLevelSpecified=false);
