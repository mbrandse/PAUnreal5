...
void FDialogueEditorStyle::Initialize()
{
...

	{
		...
		StyleSet->Set("ChoiceNodeStyle", new BOX_BRUSH("choiceNode", FMargin(5.f / 138.f, 5.f / 56.f, 5.f / 138.f, 5.f / 56.f)));
		...
		StyleSet->Set("EventNodeStyle", new BOX_BRUSH("eventNode", FMargin(5.f / 138.f, 5.f / 56.f, 5.f / 138.f, 5.f / 56.f)));
